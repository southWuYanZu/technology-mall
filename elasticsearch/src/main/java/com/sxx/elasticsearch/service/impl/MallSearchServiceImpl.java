package com.sxx.elasticsearch.service.impl;
...
import com.sxx.elasticsearch.constant.EsConstant;
import com.sxx.elasticsearch.feign.ProductFeignClient;
import com.sxx.elasticsearch.service.MallSearchService;
import com.sxx.elasticsearch.vo.AttrResponseVo;
...
public class MallSearchServiceImpl implements MallSearchService {
    ...
    private SearchResult buildSearchResult(SearchResponse response, SearchParam param) {
        ...
        if (param.getAttrs() != null && !param.getAttrs().isEmpty()) {
            List<SearchResult.NavVo> collect = param.getAttrs().stream().map(attr -> {
                ...
                ResponseEntity r = productFeignClient.attrInfo(Long.parseLong(s[0]));
                if (r.getCode() == 0) {
    ...
    private SearchRequest buildSearchRequest(SearchParam param) {
        ...
        /*
         * 排序，分页，高亮 形式为sort=hotScore_asc/desc
         */
